...
<?php
  include 'navbar.php';
?>
<h2 class="text-center pt-4" style="color:#007bff; height: 85px; background-color:pink;margin-top:-16px;">TRANSFER MONEY</h2>
<br>
     <div class="container">
            <div class="row">
                <div class="col">
                ...
                ?>
                    <tr style="color : white;">
                        ...
                        <td><a href="selecteduserdetail.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn" style="background-color :#dc3545;" style="border-radius:0%;">Proceed</button></a></td> 
                    </tr>
                <?php
                $cnt=$cnt+1;
                    }
